...
export const makeBeaconQuery = createAsyncThunk<BeaconQueryResponse, void, { state: RootState; rejectValue: string }>('beaconQuery/makeBeaconQuery', async (payload, { getState }) => {
