...
import type { FiltersState, FtsQueryType } from '@/features/search/types';
...
export const useDownloadAllMatchesCSV = () => {
  ...
  return useCallback(
    (
      ...
      return downloadAllMatchesCSV(auth, selectedScope, filters, textQuery, textQueryType, entity, filename);
    },
    [auth, selectedScope]
  );
};
