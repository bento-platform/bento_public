                ...
                Object.entries(all_vars)
                  ...
                  .map((item) => {
                    ...
                    const field = queryParameterStack.find(
                      (e) => e.hasOwnProperty("key") && e.key == key
                    )?.props?.Item
                    if (!field) {
                      return null
                    }
                    ...
                    if (
                      ...
                      if (
                        ...
                        Object.keys(value).forEach(function (_key) {
                          ...
                          if (isNaN(attemptedDate.valueOf())) {
                            monthlybins["missing"] =
                              (monthlybins["missing"] ?? 0) + value[_key]
                            return //ie, continue
                          }
                      ...
                      if (
                        ...
                        qpList.push(
                          qpList.splice(qpList.indexOf(missingObject[0]), 1)[0]
                        )
                      }
